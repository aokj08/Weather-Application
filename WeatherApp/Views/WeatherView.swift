...
//  WeatherApp
//
//  Created by KeJian Ooi on 7/1/23.
//
    ...
    var body: some View {
        ...
        ZStack(alignment: .leading) {
            ...
            VStack {
                ...
                .padding()
                .padding(.bottom, 20)
                .foregroundColor(Color(hue: 0.675, saturation: 0.839, brightness: 0.377))
                .background(.white)
        ...
        .background(Color(hue: 0.675, saturation: 0.839, brightness: 0.377))
